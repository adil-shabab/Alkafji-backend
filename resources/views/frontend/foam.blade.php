...
<body>
  ...
  <main>
    <div class="d-flex-full ba__nn__er product__banner_bg">
        <div class="container">
          <h2 class="text-dark">Foam Products</h2>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-12 mb-5">
                    <div class="box">
                        <a href="{{asset('/uploads/Foam/'.$data->image)}}" data-fancybox="group">
                            <span class="thumb"> <img src="{{asset('/uploads/Foam/'.$data->image)}}" /></span>
                        </a>
                        <h5>{{$data->title}}</h5>
                    </div>
                </div>

...
@endsection
@section('content')
<form id="amenities-form" class="mt-5 d-flex justify-content-center align-items-center" action="{{ url('account/add-paper') }}" method="POST"  enctype="multipart/form-data">
    @csrf
   <div class="shadow w-100 row py-3" style="max-width: 400px; border-radius: 10px;">
    <div class="col-12">
      <h3 class="head___txt">Add Paper Product </h3>
...
<script>
  active = document.getElementById('paper_form')
